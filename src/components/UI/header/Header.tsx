"use client";
import {Avatar, Button, Col, Dropdown, Flex, Input, MenuProps, Row} from "antd";
            ...
            <Col flex={"auto"} style={{backgroundColor: "#496FDC", maxWidth: "100%"}}>
                <Flex justify={"space-between"} align={"center"} style={{minHeight: "100%", paddingInline: "1em"}}>
                    ...
                    }
                    {
                        user &&
                            <Dropdown menu={{items}}>
                                <Flex align={"center"} gap={'.5em'} style={{cursor: "pointer"}}>
                                    <img src={user.avatarUrl} alt={"avatar"} width={40} height={40}/>
                                    <span style={{color: "white", fontWeight: 700}}>{user.name}</span>
                                </Flex>
                            </Dropdown>
                    }
                </Flex>
